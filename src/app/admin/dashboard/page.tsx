...
export default function AdminDashboardPage() {
  ...
  // collectionGroup is most likely to cause "Index Required" hanging
  ...
  const handleSeedData = async () => {
    ...
    const seedPromises = demoVendors.map(v => {
    ...
    Promise.all(seedPromises)
      .then(() => toast({ title: "Environment Synced" }))
      .catch(() => toast({ variant: "destructive", title: "Sync Failed" }))
      .finally(() => setIsSeeding(false))
  }

  // Graceful Index Handling
  ...
  // Individual loading checks to prevent blanket hanging
  const isSyncing = studentsLoading || vendorsLoading || productsLoading
