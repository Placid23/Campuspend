...
export default function VendorDashboardPage() {
  ...
  // Optimized: Limit recent sales to 10 items
        ...
        <div className="flex flex-col items-center justify-center h-[60vh] space-y-6 text-center max-w-md mx-auto">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Firestore needs an optimized index to display your sales history efficiently.
            </p>
          </div>
          ...
          <div className="lg:col-span-12 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <GlassCard className="p-6 border-white/5">
                <div className="flex justify-between items-start mb-4">
                  <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Recent Items Sold</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <GlassCard className="p-8 border-white/5 bg-white/5 flex flex-col justify-center items-center text-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground max-w-xs mx-auto">Optimize your listings and add more items to reach more students across the campus.</p>
                </div>
